...
"2015/01/21 takemizu add 拡張子でtab幅変更
au BufNewFile,BufRead *.sql set noexpandtab tabstop=4 shiftwidth=4
...
"" add takemizu 2015/01/23
        NeoBundle 'Shougo/unite.vim'

"" add takemizu 2015/02/04
        " インデントに色を付けて見やすくする
